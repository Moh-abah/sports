...
//     // Try competitors array as fallback for some sports
...
// // Flatten stats with sport-specific handling
...
//         // Sport-specific stat labeling
//         let label = h?.displayName || h?.name || a?.displayName || a?.name || k

//         // Customize labels based on sport type
...
// // Determine sport type from league abbreviation
...
//     useEffect(() => {
//         setNews(NewsItem); // خزّن الأخبار عند تحميل الصفحة
//     }, [NewsItem, setNews]);
...
//             <main className="flex-grow container mx-auto px-4 py-8">
//                 {/* SEO-friendly page title (hidden but crawlable) */}
...
//                                         onError={(e) => {
//                                             // Fallback if league logo doesn't exist
